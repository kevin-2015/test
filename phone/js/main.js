...
var Interface = 'http://59.33.249.45:81/xxx/public/tclOA/';
var zhy_url = 'http://59.33.249.45:81/xxx/public/tclOA/';
/**
...
//login提示框
function alert_login(name,time){
	$$('login_window').innerHTML= '<div id="mengban" class="mengban"></div>'
+'<div id="window" class="window">'
+'<div class="zhy_w">'
+'<div class="ub  zhy_login_bg  t-wh uc-tl1 uc-tr1 zhy_err_bg">	'
 +'<div class="ub ub-pc ub-ac uc-l1 ">'
 	+'<div class="zhy_yw uinn"></div>'
 +'</div>	' 
+'<div class="ub-f1 uinn ub ub-ac ub-pc">错误提示</div>	'
 +'</div>'
+'<div class="ub ub-ver c-wh uc-br1 uc-bl1 zhy_xx_com">	'
 +'<div class=" uinn uc-t1 zhy_tsxx">'+name+'</div>'
+'</div>'
	+'</div>'
+'</div>'	;

	var time_go=setTimeout(function(){
			$$('login_window').innerHTML='';
	},time);		
	clearTimeout('time_go');
	
}
function alert_logins(title,name,time){
	$$('login_window').innerHTML= '<div id="mengban" class="mengban"></div>'
+'<div id="window" class="window">'
+'<div class="zhy_w">'
+'<div class="ub  zhy_login_bg  t-wh uc-tl1 uc-tr1 zhy_err_bg">	'
 +'<div class="ub ub-pc ub-ac uc-l1 ">'
 	+'<div class="zhy_yw uinn"></div>'
 +'</div>	' 
+'<div class="ub-f1 uinn ub ub-ac ub-pc">'+title+'</div>	'
 +'</div>'
+'<div class="ub ub-ver c-wh uc-br1 uc-bl1 zhy_xx_com">	'
 +'<div class=" uinn uc-t1 zhy_tsxx">'+name+'</div>'
+'</div>'
...
function successful(prompt,name){
	$$('che_ti').innerHTML= '<div id="mengban" class="mengban"></div>'
			+'<div id="window" class="window">'
+'<div class="zhy_w">'
+'<div class="ub  zhy_login_bg  t-wh uc-tl1 uc-tr1 zhy_err_bg">	'
+'<div class="ub ub-pc ub-ac uc-l1 ">'
+'<div class="zhy_yw uinn"></div>'
+'</div>	'
+'<div class="ub-f1 uinn ub ub-ac ub-pc">'+prompt+'</div>'	
+'</div>'
+'<div class="ub ub-ver c-wh uc-br1 uc-bl1 zhy_xx_com">	'
+'<div class=" uinn uc-t1 zhy_tsxx">'+name+'</div>'
+'<div class="ub-f1 uinn ">'
                                   +' <div onclick="clo()" ontouchstart="zy_touch(\'btn-act\')" class="btn ub ub-ac ub-pc  uinn5 zhy_login_bg c-m1 uc-a t-wh">'
                                       +' OK'
                                   +' </div>'
                                +'</div>'
+'</div>'
