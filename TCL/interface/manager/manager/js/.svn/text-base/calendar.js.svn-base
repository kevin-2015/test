...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\"images/time1.png\">", 1, -2);
	this._nav_py.width = 20;
//	this._nav_py = hh("&#x00ab;", 1, -2);
	this._nav_py.ttip = Calendar._TT["PREV_YEAR"];
	
	//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\"images/time2.png\">", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\"images/time3.png\">", 1, 1);
	this._nav_nm.width = 20;
	this._nav_nm.ttip = Calendar._TT["NEXT_MONTH"];

//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\"images/time4.png\">", 1, 2);
